    ...
    create: function (req, res, next) {
        ...
        if(params){
            ...
            MatchExtra
                ...
                .spread(function(matchextra, created) {
                    ...
                    async.waterfall([
                        ...
                        /*function (next) {
                            if(params.events.cards) {
                                var done = 0;
                                async.forEach(params.events.cards, function (event, callback) {
                                    Player
                                        .findOrCreate({
                                            where: {id_RF: event.player_id},
                                            defaults: {id_RF: event.player_id, alias:event.alias, nick:event.player, TeamId: event.team == 'local' ? params.local_id : params.visitant_id}
                                        ...
                                        Event
                                            ...
                                            .spread(function (matc, crea) {
                                                ...
                                                if (done === params.events.cards.length){
                                                    next()
                                                }
                                                else {
                                                    callback();
                        ...
                        function (next) {
                            if (params.events.others) {
                                var done = 0;
                                async.forEach(params.events.others, function (event, callback) {
                                    Player
                                        .findOrCreate({
                                            where: {id_RF: event.player_id},
                                            defaults: {id_RF: event.player_id, alias:event.alias, nick:event.player, TeamId: event.team == 'local' ? params.local_id : params.visitant_id}
                                        ...
                                        Event
                                            ...
                                            .spread(function (matc, crea) {
                                                ...
                                                if (done === params.events.others.length){
                                                    next()
                                                }
                                                else {
                                                    callback();
                        ...
                        function (next) {
                            if (params.events.goals) {
                                var done = 0;
                                async.forEach(params.events.goals, function (event, callback) {
                                    Player
                                        .findOrCreate({
                                            where: {id_RF: event.player_id},
                                            defaults: {id_RF: event.player_id, alias:event.alias, nick:event.player, TeamId: event.team == 'local' ? params.local_id : params.visitant_id}
                                        ...
                                        Event
                                            ...
                                            .spread(function (matc, crea) {
                                                ...
                                                if (done === params.events.goals.length){
                                                    next()
                                                }
                                                else {
                                                    callback();
                        ...
                        function (next) {
                            if (params.events.changes) {
                                var done = 0;
                                async.forEach(params.events.changes, function (event, callback) {
                                    Player
                                        .findOrCreate({
                                            where: {id_RF: event.player_id},
                                            defaults: {id_RF: event.player_id, alias:event.alias, nick:event.player, TeamId: event.team == 'local' ? params.local_id : params.visitant_id}
                                        }).spread(function (player, crea) {
                                        Event
                                            .findOrCreate({
                                                where: {
                                                    MatchId: params.MatchId,
                                            ...
                                            .spread(function (matc, crea) {
                                                ...
                                                if (done === params.events.changes.length){
                                                    next()
                                                }
                                                else {
                                                    callback();
            ...
            /*if(created) {
             ...
             console.log(match);
             return res.status(200).json(helpers.formatErrors(null,controller_name,req.method, match));
             }*/
